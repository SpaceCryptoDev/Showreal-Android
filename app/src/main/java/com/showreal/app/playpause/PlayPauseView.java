package com.showreal.app.playpause;
...
public class PlayPauseView extends FrameLayout {
    ...
    public PlayPauseView(Context context, AttributeSet attrs) {
        ...
        mBackgroundColor = getResources().getColor(R.color.white87);
        mPaint.setAntiAlias(true);
        mPaint.setStyle(Paint.Style.FILL);
        mDrawable = new PlayPauseDrawable(context);
        mDrawable.setCallback(this);

        mPauseBackgroundColor = getResources().getColor(R.color.white87);
        mPlayBackgroundColor = getResources().getColor(R.color.white87);
    }
    ...
    public void toggle(boolean animated) {
        ...
        final Animator pausePlayAnim = mDrawable.getPausePlayAnimator();
        mAnimatorSet.setInterpolator(new DecelerateInterpolator());
        mAnimatorSet.setDuration(animated ? PLAY_PAUSE_ANIMATION_DURATION : 0);
        mAnimatorSet.playTogether(colorAnim, pausePlayAnim);
        mAnimatorSet.start();
    }

    public void hideAnimated(int delay) {
        cancelAnimation();
        if (getVisibility() == GONE) {
            return;
        }
        AnimationHelper.fadeOut(this, 400, delay);
    }
    ...
    public void hide(boolean delay) {
        ...
        if (delay) {
            AnimationHelper.fadeOut(this, 200, 0);
        } else {
            setVisibility(GONE);
        }
    }
    ...
    public void show() {
        ...
        AnimationHelper.fadeIn(this, 200, 0);
    }
